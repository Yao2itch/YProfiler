    ...
    public static class UnityProfilerRecorder
    {
        ...
        public static void StartRecording(bool includeUnityFormat = false)
        {
            ...
            for (var area = 0; area  < profilerAreaCount; area++)
            {
                ...
                // UnityEngine.Debug.Log($" ## Uni Output ## cls: func: info: --- area:{areaValue.ToString()} --- ");
...
#endif
                    // UnityEngine.Debug.Log($" ## Uni Output ## cls: func: info: --- --- --- property:{name} --- ");
                    
                    stream.Write(name);
                    
                    children.Add(identifier);
                }
                // UnityEngine.Debug.Log(" ## Uni Output ## cls: func: info: --- ---");
            }
        ...
        static void Update()
        {
            ...
            UnityEngine.Debug.Log($" ## Uni Output ## cls: func: info: +++ +++ frameIdx={frameIndex} +++ +++");
            ...
            while (frameIndex <= stopFrameIndex)
            {
                ...
                for (var area = 0; area < profilerAreaCount; area++)
                {
                    ...
                    // UnityEngine.Debug.Log($" ## Uni Output ## cls: func: info: +++ +++ area={areaValue} fIdx={frameIndex} +++ +++");
                    ...
                    for(var i = 0; i < properties.Length; ++i)
                    {
                        ...
                        ProfilerDriver.GetCounterValuesBatch((ProfilerArea)area, properties[i], frameIndex, 1.0f,
                            provider, out maxValue);
                        
                        // UnityEngine.Debug.Log($" ## Uni Output ## cls: func: info: +++ +++ area={areaValue} fIdx={frameIndex} prop={properties[i]} val={provider[0]} +++ +++");
